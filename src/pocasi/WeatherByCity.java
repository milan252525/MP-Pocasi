...
public class WeatherByCity {
    ...
    private final String main, description, icon, base, country, name;
    private final long id, dt, sunrise, sunset;

    public WeatherByCity(String city) throws IOException{
        //vytvoreni url
